...
//                  downloadDiv +
                    ...
                    getCurCNDDate() + '</a><i>|</i><span id="jToolbarWeather"></span>'+ jFHtml + '</div>' + weatherother;
            } else { /***非登陆**/
                ...
                html = '<div id="jToolbarUser" class="account">' + '<div class="skinOpen"><a href="http://www.chinaso.com" class="a_index" style="color: #993300;">中国搜索首页</a><span class="a_index_span">|</span>' + '<a id="jToolbarLogin" href="' + loginUrl + '" class="a_login">登录</a><a id="jToolbarReg" href="' + registerUrl + '">注册</a><span>|</span>' +
                    ...
                    // downloadDiv + 
                    '</div>' + 
                    '<div class="fl top_data">' + '<span id="jToolbarTime">' + setTimeArea() + '</span><a href="http://www.chinaso.com/search/pagesearch.htm?q=%E5%86%9C%E5%8E%86" target="_blank" class="date_lunar">' + getCurCNDDate() + '</a><i>|</i><span id="jToolbarWeather"></span>'+ jFHtml + '</div>' + weatherother;
            }
        } else { /***非主页**/
            if (isLogin()) { /***登陆状态**/
                uname = cookieUtil.get(CONST.COOKIE_USER_NAME, true) || "";
...
//                    downloadDiv + 
                ...
                if (pageRankElems.length > 0) {
                    ...
                    html += '<span id="jToolbarTime">' + setTimeArea() +
                        '</span><a target="_blank" href="http://www.chinaso.com/search/pagesearch.htm?q=%E5%86%9C%E5%8E%86" class="date_lunar">' + getCurCNDDate() + '</a><i>|</i><span id="jToolbarWeather"></span>+ jFHtml + </div>' + weatherother;
                }
...
//                    downloadDiv + 
                ...
                if (pageRankElems.length > 0) {
                    ...
                    html += '<span id="jToolbarTime">' + setTimeArea() + '</span><a target="_blank" href="http://www.chinaso.com/search/pagesearch.htm?q=%E5%86%9C%E5%8E%86" class="date_lunar">' +
                        getCurCNDDate() + '</a><i>|</i><span id="jToolbarWeather"></span>' + jFHtml;
                }
    ...
    function getJFHtml(){
        var hostName = window.location.hostname,
            returnHtml = '<i>|</i><span id="simpleHref" style="margin-right: 0;">'+
                '<a href="http'+':/'+'/www.chinaso.com/" style="color: @SIMPLE@;margin-right:0;">'+
                decodeURIComponent("%E7%AE%80%E4%BD%93%E7%89%88")+'</a></span><i>|</i><span id="traditionalHref">'+
                '<a href="http://big5.chinaso.com/big5/www.chinaso.com/" style="color: @TRADITIONAL@;margin-right:0;">繁體版</a></span>',
            curColor = '#06c;text-decoration:none',
            hrefColor = '#666';
        if(hostName.indexOf('big5.chinaso.com') === -1){
            returnHtml = returnHtml.replace('@SIMPLE@', curColor).replace('@TRADITIONAL@', hrefColor);
        }else{
            returnHtml = returnHtml.replace('@SIMPLE@', hrefColor).replace('@TRADITIONAL@', curColor);
        }
        return returnHtml;
    }
