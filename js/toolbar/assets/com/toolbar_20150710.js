BL.Com.Toolbar = (function (BL) {
    var CONST = {
            ...
            EXCEPT_URLS: ['www.chinaso.com', 'report.chinaso.com', 'map.chinaso.com', 'video.chinaso.com', 'image.chinaso.com', '123.chinaso.com', 'news.chinaso.com', 'music.chinaso.com', 'tuan.chinaso.com']
        },
        CONF = {
        ...
        if (isHomePage()) { /***主页**/
            ...
            uname = cookieUtil.get(CONST.COOKIE_USER_NAME, true) || "";
                ...
                html = '<div id="jToolbarUser" class="account">' + '<div class="skinOpen">' +
                    ...
                    '<i class="arrow_down"></i></a><span>|</span>' +
...
//                  downloadDiv +
            ...
            var redirect = window.location.href;
                var loginUrl = CONF.URL_LOGIN + "?url=" + encodeURIComponent(encodeURIComponent(encodeURIComponent(redirect)));
                //var registerUrl = CONF.URL_REG + "?url=" + encodeURIComponent(encodeURIComponent(encodeURIComponent(redirect))) + "#register";
                html = '<div id="jToolbarUser" class="account">' + '<div class="skinOpen"><a href="http://www.chinaso.com" class="a_index" style="color: #993300;">中国搜索首页</a><span class="a_index_span">|</span>' + '<a id="jToolbarLogin" href="' + loginUrl + '" class="a_login">一键登录</a><span>|</span>' +
                        // versionSel
                        //				+ appApplication +'<span>|</span>' +
            ...
            uname = cookieUtil.get(CONST.COOKIE_USER_NAME, true) || "";
                ...
                html = '<div id="jToolbarUser" class="account">' + '<div class="skinOpen"><a href="http://www.chinaso.com" class="a_index" style="color: #993300;">中国搜索首页</a><span class="a_index_span">|</span>' + '<b class="head_pic"></b><a target="_blank" title="点击进入用户中心" href="http://my.chinaso.com/conf/index.htm" class="a_user">' + uname + '<i class="arrow_down"></i></a><span>|</span>' +
                        //                    appApplication + '<span>|</span>' +
...
//                    downloadDiv + 
    ...
    function getVerticalNav(){
        ...
        if(flag){
            html = '<div class="chinaso_all_top_nav clearb"><ul>'+
                '<li><a href="http://report.chinaso.com/" target="_blank">国搜报道</a></li>'+
                '<li><a href="http://news.chinaso.com/" target="_blank">新闻搜索</a></li>'+
                '<li><a href="http://nation.chinaso.com/" target="_blank">国情</a></li>'+
                '<li><a href="http://local.chinaso.com/" target="_blank">地方</a></li>'+
                '<li><a href="http://finance.chinaso.com/" target="_blank">财经</a></li>'+
                '<li><a href="http://world.chinaso.com/" target="_blank">国际</a></li>'+
                '<li><a href="http://mil.chinaso.com/" target="_blank">军事</a></li>'+
                '<li><a href="http://society.chinaso.com/" target="_blank">社会</a></li>'+
                '<li><a href="http://law.chinaso.com/" target="_blank">法治</a></li>'+
                '<li><a href="http://tech.chinaso.com/" target="_blank">科技</a></li>'+
                '<li><a href="http://sports.chinaso.com/" target="_blank">体育</a></li>'+
                '<li><a href="http://ent.chinaso.com/" target="_blank">娱乐</a></li>'+
                '<li><a href="http://food.chinaso.com/" target="_blank">美食</a></li>'+
                '<li><a href="http://auto.chinaso.com/" target="_blank">汽车</a></li>'+
                '<li><a href="http://house.chinaso.com/" target="_blank">房产</a></li>'+
                '<li><a href="http://home.chinaso.com/" target="_blank">家居</a></li>'+
                '<li><a href="http://tuan.chinaso.com/" target="_blank">团购</a></li>'+
                '<li><a href="http://shuhua.chinaso.com/" target="_blank">书画</a></li>'+
                '<li><a href="http://hn.chinaso.com/" target="_blank">河南</a></li>'+
                '<li><a href="http://dl.chinaso.com/" target="_blank">大连</a></li>'+
                '<li><a href="http://edu.chinaso.com/" target="_blank">教育</a></li>'+
                '<li class="no"><a href="http://qy.chinaso.com/" target="_blank">企业</a></li>'+
                '</ul></div>';
        }
    ...
    function render() {
        ...
        //添加垂直频道导航.
        var verticalNav = getVerticalNav();
        $('#'+CONST.CID).after(verticalNav);
    }
